...
import cloudinary # Import the package
...
INSTALLED_APPS = [
    ...
    'tinymce',
    'cloudinary', # The core cloudinary app
...
# --- Cloudinary Configuration (replaces MEDIA settings) ---
# This is the central configuration for the cloudinary package
cloudinary.config(
