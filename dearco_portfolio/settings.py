...
INSTALLED_APPS = [
    ...
    'tinymce', 'cloudinary',
    'core.apps.CoreConfig', 'blog.apps.BlogConfig', 'portfolio.apps.PortfolioConfig',
    'site_settings.apps.SiteSettingsConfig', 'agency.apps.AgencyConfig',
]
MIDDLEWARE = [
...
# Moved to a function to prevent blocking on startup
