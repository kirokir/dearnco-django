...
INSTALLED_APPS = [
    ...
    'tinymce', 'cloudinary', 'core.apps.CoreConfig', 'blog.apps.BlogConfig',
    'portfolio.apps.PortfolioConfig', 'site_settings.apps.SiteSettingsConfig',
]
MIDDLEWARE = [
...
if IS_PRODUCTION:
    # Production settings: Use PostgreSQL from DATABASE_URL
    DATABASES = {
    ...
    # Local development settings: Use SQLite
    DATABASES = {
        'default': {
