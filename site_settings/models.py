...
class SiteConfiguration(SingletonModel):
    ...
    hero_image_opacity = models.PositiveIntegerField(default=20, help_text="Opacity of the hero image (0-100).")
    hero_image_blur = models.PositiveIntegerField(default=5, help_text="Blur effect on the hero image in pixels (0-20).")
